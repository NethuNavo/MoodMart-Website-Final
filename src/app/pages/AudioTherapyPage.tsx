              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg font-medium transition-all duration-200 whitespace-nowrap ${
                  selectedCategory === category
                    ? 'bg-gradient-to-r from-purple-600 to-violet-600 text-white shadow-lg hover:brightness-110'
          ...
          <div className="w-full max-w-md ml-auto">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-full border-2 border-purple-200 bg-white px-12 py-3 text-sm text-gray-700 shadow-sm transition-all duration-200 focus:border-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-200"
              />
            </div>
          </div>
        </div>
